...
export const setInstanceProxy = (id: string, url: string | null) =>
  api.patch<{ proxyUrl: string | null }>(`/instances/${id}/proxy`, { url });
export const testInstanceProxy = (id: string, url?: string) =>
  api.post<{ success: boolean; ip?: string; proxy?: string; error?: string }>(`/instances/${id}/proxy/test`, { url });
...
export type WebhookTestResult = { success: boolean; statusCode: number | null; durationMs: number; error?: string };
...
export const getWebhookLogs = (id: string) => api.get<WebhookLog[]>(`/instances/${id}/webhook/logs`);
export const testWebhook = (id: string) => api.post<WebhookTestResult>(`/instances/${id}/webhook/test`);
export const deleteWebhookSecret = (id: string) => api.delete(`/instances/${id}/webhook/secret`);
...
export const addGroupListMembers = (
  listId: string,
  members: { group_jid: string; label?: string | null }[]
...
export const getPublicConfig = () =>
  api.get<{ contactEmail: string }>("/public/config");
